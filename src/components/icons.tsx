  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_4130_511)">
        ...
        <path
          fill="#5E60CE"
          d="M14.896 27.596a1.364 1.364 0 00-.975.368 1.326 1.326 0 00-.414.943v4.16c0 .363.146.71.407.967a1.4 1.4 0 001.964 0c.26-.256.407-.604.407-.967v-4.103a1.305 1.305 0 00-.371-.958 1.345 1.345 0 00-.954-.41h-.064zM7.162 27.596a1.382 1.382 0 00-.999.357 1.34 1.34 0 00-.434.954v4.16c0 .363.147.71.407.967a1.4 1.4 0 001.965 0c.26-.256.407-.604.407-.967v-4.104a1.307 1.307 0 00-.371-.957 1.345 1.345 0 00-.954-.41h-.021zM10.921 27.596a1.378 1.378 0 00-.97.372 1.34 1.34 0 00-.419.94v5.731c0 .363.146.71.407.967a1.4 1.4 0 001.965 0c.26-.256.407-.604.407-.967V29a1.304 1.304 0 00-.372-.957 1.347 1.347 0 00-.953-.411l-.065-.035z"
        ></path>
      </g>
      <defs>
...
export const PlusIcon = ({ ...props }) => {
  return (
    <svg
      ...
      {...props}
    >
      <g fill="#F2F2F2" clipPath="url(#clip0_5911_24)">
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <use transform="scale(.01)" xlinkHref="#image0_4130_503"></use>
        </pattern>
        <image
          id="image0_4130_503"
          width="100"
